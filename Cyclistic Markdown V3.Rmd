...
I then proceeded to explore my raw dataset using SQL. As a first step, I queried for null values, outlier values, and tested for duplicate values relating to station IDs in particular. Here are metrics from the raw data set:
...
Below are metrics for the cleaned dataset:
