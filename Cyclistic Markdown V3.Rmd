...
-   Download monthly data from Divvy via [divvy-tripdata](https://divvy-tripdata.s3.amazonaws.com/index.html).

-   Upload monthly data onto [MotherDuck](https://app.motherduck.com/), a cloud data warehouse, then use SQL to clean, process and analyze the data set.
